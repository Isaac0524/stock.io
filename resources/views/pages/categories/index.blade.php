  ...
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="charts">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> 
            <a class="nav-link"    data-bs-toggle="tooltip" title="Consultez les statistiques de vos stocks">Analyse des stocks</a>
          </li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="icons">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> 
            <a class="nav-link"    data-bs-toggle="tooltip" title="Consultez la liste des fournisseurs">Liste des fournisseurs</a>
          </li>
        </ul>
      </div>
    </li>
