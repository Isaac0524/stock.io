...
<body>
 <nav 
 class="navbar fixed-top d-flex flex-row">
                            ...
                            <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach ($ventes as $vente)
                                                    <tr>
                                                        ...
                                                        <td>{{ number_format($vente->prix_total, 0, ',', ' ') }} FCFA</td>
                                                        <td>{{ $vente->client }}</td>
                                                        <td>{{ $vente->user->name ?? 'Utilisateur supprimé' }}</td> <!-- Affiche le nom de l'utilisateur -->
                                                        <td>{{ \Carbon\Carbon::parse($vente->created_at)->format('d/m/Y H:i') }}</td>
                                                        <td>
                                                            <a href="{{ route('recu.pdf', $vente->id) }}" class="btn btn-sm btn-success">
                                ...
                                @else
                                    <div class="text-center py-5">
                                        <img src="{{ asset('assets/images/no-data.svg') }}" alt="Aucune donnée" style="max-width: 200px; opacity: 0.5;">
