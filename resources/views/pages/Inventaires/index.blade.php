                      ...
                      <table class="table table-hover">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      @php
                                          $rating = $produit->evaluation ?? 0; // Ajoutez une colonne 'evaluation' à votre table produits
                                      @endphp
                                  ...
                                  <td class="action-buttons">
                                      <a href="{{ route('Products.show', ['id' => $produit->id]) }}" class="btn btn-sm btn-primary">Voir</a>
                                      <a href="{{ route('Products.edit', ['id' => $produit->id]) }}" class="btn btn-sm btn-warning">Modifier</a>
