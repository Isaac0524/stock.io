                ...
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tooltip" data-bs-placement="right"
                            title="Accédez à votre tableau de bord principal">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('ventes.create') }}" data-bs-toggle="tooltip"
                                        title="vendre un Produit ">Effectue une vente</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('ventes.index') }}" data-bs-toggle="tooltip"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    {% else %}
                                                    <tr>
                                                        <td colspan="5" class="text-center">Aucune vente trouvée
                                                        </td>
                                                    </tr>
                                                    {% endif %}
                                                </tbody>
